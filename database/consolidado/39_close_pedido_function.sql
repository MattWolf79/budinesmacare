...
-- Cierre exclusivo para empresas en modo pedido.
-- No reemplaza close_booking_attention para no afectar empresas de turnos.
drop function if exists public.close_booking_attention_pedido(date, text, text, uuid[], jsonb, jsonb, jsonb, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, uuid, text);
