...
export default function ClientLayout({
  ...
  const heroTitle =
    activeView === 'home'
      ? (
          <span className="client-welcome-name">
            {companyName}
          </span>
        )
      : (
      ...
      <div className="role-workspace-body">
        ...
        <div className="role-workspace-content">
          ...
          >
            {activeView === 'home' &&
              businessHoursText && (
                <p className="client-business-hours-text">
                  {businessHoursText}
                </p>
              )}
          </WorkspaceHero>
